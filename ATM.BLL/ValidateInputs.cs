...
namespace ATM.BLL
{
    public class ValidateInputs
    {
        ...
        public async Task ValidateCardDetails()
        {
            ...
            ApplicationDbContextFactory contextDbfactory = new ApplicationDbContextFactory();
            var dbContext = contextDbfactory.CreateDbContext(null);
            
            try
            {
                
                bool anyCustomer = await dbContext.Customer.AnyAsync();
